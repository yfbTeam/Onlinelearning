<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Course_WorkEdit.aspx.cs" Inherits="SSSWeb.OnlineLearning.Course_WorkEdit" %>
    ...
    <script>
        ...
        function Notice_StudyTheCourseStu(newworkid) {
            $.ajax({
                ...
                async: false,
                dataType: "json",
                data: { PageName: "/OnlineLearning/MyLessonsHandler.ashx", "Func": "StudyTheCourseStaff", CourseID: UrlDate.courseid },
                success: function (json) {
                    if (json.result.errNum.toString() == "0") {
