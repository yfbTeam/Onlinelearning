<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StuLessonDetail.aspx.cs" Inherits="SSSWeb.OnlineLearning.StuLessonDetail" %>
...
<head>
            ...
            <div class="fr mycourse_mes">
                ...
                <h2 class="clearfix">
                    ...
                    <%--<div class="fl people_number">
                        选课人数上限：<span>${StuMaxCount} ({{if CourceType==1}}必须提交论文或作业{{else}}可不提交论文或作业{{/if}})</span>
                    </div>--%>
                </h2>
                <div class="course_desc">${CourseIntro}</div>
               <div id="div_SignUp" style="display:none;"><a href="javascript:;" onclick="SinUp(${ID})" class="course_btn btnprice_bgfree">
					立即报名
				</a></div>
            </div>
        </li>
            ...
            <div class="test_lists_right fr clearfix">
                <div class="dates_a  pr" style="width: 280px">
                    <div class="seedeletion seedeletiona" >
                        <a href="javascript:;" class="homework fl" onclick="LookCurWork('${Id}');" style="padding:0px 4px;"><i class="icon icon-download-alt" style="color:#fff;"></i>查看作业</a>
                        {{if IsCanCorrect==0}} 
            ...
            <div class="homework_mes clearfix">
                ...
                <div class="homework_mes_right fr">
                    <div class="homework_mes_a">
                        <a href="javascript:;" onclick="LookCurWork('${Id}');" class="homework fl"><i class="icon icon-download-alt"></i>查看作业</a>                        
                       {{if IsMember!=0}} 
                        {{if IsCanCorrect==0}} 
                        ...
                        {{else}}    
                            ...
                            <a href="javascript:;" class="homework homeworkb pr">  
                                <div id="uploadify_${Id}" name="uploadify" class="uploadify_work"><i class="icon icon-upload-alt" style="color:#fff;"></i>提交作业</div>                              
    ...
    <style type="text/css">
        ...
        .test_lists li .test_lists_right .seedeletiona .homeworka span {
            width: auto;
            line-height: 18px;
        }

        .test_lists li .test_lists_right .seedeletiona .homeworka .uploadify {
            top: 0;
        }
...
<body>
    ...
    <input type="hidden" id="HStuIDCard" runat="server"/>
        <input type="hidden" id="HClassID" <%=UserInfo.RegisterOrg %> />
    <!--header-->
           ...
           <a class="logo fl" href="../AppManage/Index.aspx">
            ...
            <nav class="navbar menu_mid fl">
                <ul id="Menu">
                    ...
                    <li class="active"><a href="../PersonalSpace/PersonalSpace_Student.aspx#course-2">在学课程</a></li>
    ...
    <div class="width course_process_wrap bordshadrad mb10" style="display:none;">
    ...
    <div class="width course_student_wrap clearfix">
        <div class="clearfix pr" style="display: block;min-height:270px;">
            <div class="course_student clearfix pr bordshadrad" id="course_dsleft">
                <div class="shadow_left">
                    <span></span>
                    <span></span>
                </div>
                ...
                <div class="course_student_right" >
                    <%--<div class="stytem_select clearfix">
            ...
            <div class="course_learned bordshadrad pr" id="course_dsright">
                <div class="shadow_left">
                    <span></span>
                    <span></span>
                </div>
                ...
                <p class="learned_title">正在学习的员工</p>
                <div class="class_selectwrap">
                    <ul class="class_select" id="ul_studystu"><li><span>暂无正在学习的员工！</span></li></ul>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
         ...
         GetSameLiveMenu("PersonalSpace/PersonalSpace_Student.aspx#course-2", '<%=UserInfo.UniqueNo%>', '');
        ...
        $("#a_parentUrl").attr("href", "/PersonalSpace/PersonalSpace_Student.aspx#course-" + UrlDate.flag || 1);
        InitTab();
        getData(1, 10);
        //用户签到
        UserSingLog()
    ...
    function OnSuccess(json) {
        if (json.result.errNum.toString() == "0") {
            ...
            Teacher_IDCard = rtnData[0].CreateUID, Teacher_Name = rtnData[0].BatchUserName;
            $("#ul_mylessons").html('');
            ...
            Star();
            SetLastStudyTime(rtnData[0].SelId);
        }
        else {
            ...
            $.ajax({
                ...
                success: function (json) {
                    if (json.result.errNum.toString() == "0") {
                        ...
                        $("#ul_mylessons").html('<li style="text-align:center">暂无该课程！</li>');
                    }
                },
                error: function () {
                    $("#ul_mylessons").html('<li style="text-align:center">暂无该课程！</li>');
    ...
    function StudyTheCourseStu(coursetype) {
        ...
        $.ajax({
            ...
            async: false,
            dataType: "json",
            data: { PageName: "OnlineLearning/MyLessonsHandler.ashx", "Func": "StudyTheCourseStaff", CourseID: UrlDate.itemid },
            success: function (json) {
                if (json.result.errNum.toString() == "0") {
                    studyTheCourseStaff = json.result.retData;
                    studyTheCourseStaff_Count = json.result.retData.length;
                    if (json.result.retData.length <= 0) {
                        $("#ul_studystu").html("<li><span>暂无正在学习的员工！</span></li>");
                    } else {
                        $("#ul_studystu").append("<li><ul style='display: block;' id='ul_grade'></ul></li>");
                        $("#ul_grade").append("<li><ul id=\"ul_class\" class='learned_students_lists clearfix' style='display: block;'></ul></li>");
                        $(json.result.retData).each(function () {
                            $("#ul_class").append("<li><div class='learned_students_img'><img src=\"" + this.AbsHeadPic + "\" alt='' onerror=\"javascript:this.src='../images/discuss_img_01.jpg'\"/></div><p class='learned_students_name' title=\"" + this.Name + "\">" + (this.Name.length > 3 ? cutstr(this.Name, 4) : this.Name) + "</p></li>");
                        });
    ...
    function UserSingLog() {
        $.ajax({
            ...
            data: {
                PageName: "/OnlineLearning/MyLessonsHandler.ashx",
                Func: "SinLogAdd",
                UserID: '<%=UserInfo.UniqueNo %>',
                CourseID:UrlDate.itemid
            },
            success: function (json) { }
        });
    }
    function SetLastStudyTime(selid) {
        $.ajax({
            url: "../Common.ashx",
            type: "post",
            dataType: "json",
