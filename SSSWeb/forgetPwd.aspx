<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="forgetPwd.aspx.cs" Inherits="SSSWeb.forgetPwd" %>
                    ...
                    <div class="retrievepwd-cont">
                        <ul class="register-process-list">
                            <li class="clearfix">
                                ...
                                <div class="left">
                                    <div class="clearfix">
                                        <input id="LoginName" maxlength="50" name="validate" class="ui-inp" type="text" />
                                    </div>
                                </div>
                            </li>
        ...
        $(function () {
            ...
            $("#btnNext").on("click", function () {
                ...
                if (codeNumber == code && codeNumber != "-1") {
                    window.location.href = "rePassword.aspx?loginName=" + loginName;
                    //window.location.href = "rePassword.aspx?sf=" + sf + "&loginName=" + loginName;
                } else {
                    layer.msg("请输入正确验证码！");
                }
            })
