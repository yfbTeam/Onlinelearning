<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Status_ClassExam.aspx.cs" Inherits="SSSWeb.StatisticalAnalysis.Status_ClassExam" %>
            ...
            <div class="width repository_header clearfix">
                ...
                <nav id="teacher" class="navbar menu_mid fl">
                    <ul>
                        ...
                        <li class="active"><a href="Status_ClassExam.aspx">考试管理</a></li>
    ...
    function GetMyClass() {
        $.ajax({
            ...
            data: {
                Func: "GetClass",
                Ispage: "false",
                HeadteacherNO: "<%=UserInfo.UniqueNo%>"
            },
            success: function (json) {
                if (json.result.errNum.toString() == "0") {
                    var i = 1;
                    $(json.result.retData).each(function () {
                        if (ClassNoS.indexOf(this.ClassNO) < 0) {
                            if (json.result.retData.length == i) {
                                ClassNoS += this.ClassNO;
                            }
                            else {
                                ClassNoS += this.ClassNO + "|";
                            }
        ...
        $.ajax({
            ...
            success: function (json) {
                ...
                if (json.result.errNum.toString() == "0") {
                    ...
                    var html = '<li><div style="background:#fff url(../images/error.png) no-repeat center center; height: 500px;"></div></li>';
                    if (states == 0) {
                        $("#YesExam").hide();
                        $("#NoExam").show();
                        $("#pageBar").hide();
