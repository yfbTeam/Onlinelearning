<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StudyProcgress.aspx.cs" Inherits="SSSWeb.StatisticalAnalysis.StudyProcgress" %>
        ...
        <header class="repository_header_wrap manage_header">
            <div class="width repository_header clearfix">
                ...
                <nav class="navbar menu_mid fl">
                    <ul>
                        <li class="active"><a href="#">学习进度查看</a></li>
                        <li><a href="Status_ExamScore.aspx">考试成绩统计</a></li>
                    </ul>
