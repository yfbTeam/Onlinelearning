<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Status_ClassCourse_TaskList.aspx.cs" Inherits="SSSWeb.StatisticalAnalysis.Status_ClassCourse_TaskList" %>
...
<head>
    ...
    <script id="tr_User" type="text/x-jquery-tmpl">
        <tr>
            ...
            <td><a style="cursor:pointer;" href= '/StatisticalAnalysis/TaskDetail.aspx?itemid=${ID}&StuNo=${StuNo}'>作业详情</a> </td>
        </tr>
    </script>
        ...
        <div class="onlinetest_item width pt90">
            <div class="course_manage bordshadrad">
                ...
                <div class="newcourse_select clearfix" id="CourseSel">
                    <div class="crumbs fl">
                        <a id="Mycource" style="cursor: pointer;" href="Status_ClassCourse.aspx">班级课程</a>
                        <span>></span>
                        <a href="#">作业统计</a>
