<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Recruit_StuInfo.aspx.cs" Inherits="SSSWeb.Recruit.Recruit_StuInfo" %>
    ...
    <script id="tr_User" type="text/x-jquery-tmpl">
        <tr>
            ...
            <td>{{if Status==1}}审核通过
                {{else}}
                {{if Status==2}}审核失败
                {{else}}<a href="javascript:;" onclick="Check(${ID})">审核</a>{{/if}}
                               {{/if}} 
                ...
                <div class="newcourse_select clearfix" id="CourseSel">
                    ...
                    <div class="stytem_select_right fl" style="margin-left: 10px;">
                        ...
                        <div class="search_exam fl pr">
                            ...
                            <input type="text" name="" id="Name" value="" placeholder="请输计划名称">
...
<script type="text/javascript">
    ...
    function getData(startIndex, pageSize) {
        ...
        $.ajax({
            ...
            dataType: "json",
            data: {
                "PageName": "Recruit/RecruitHandler.ashx", "Func": "GetStuInfo", PageIndex: startIndex, pageSize: pageSize, "PlanName": $("#Name").val()
            },
    ...
    //修改菜单
    function Check(id) {
        OpenIFrameWindow('审核报名信息', 'Check_Stu.aspx?ID=' + id, '430px', '540px');
    }
