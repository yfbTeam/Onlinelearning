<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Learning_center_portal.aspx.cs" Inherits="SSSWeb.PersonalSpace.Learning_center_portal" %>
                ...
                <div class="studends_center_right fr" style="width: 220px;">
                    <div class="personal_mes bordshadrad" style="height: auto; background: #fff;">
                        <div class="personal_img">
                            <img src="<%=UserInfo.AbsHeadPic%>" alt="" />
                        </div>
    ...
    <script>
        ...
        function SinUp(ID) {
            ...
            $.ajax({
                ...
                data: { "PageName": "CourseManage/CourceManage.ashx", Func: "SingUp", CourseID: ID, StuNo: Stu, StuName: StuName, ClssID: $("#HClassID").val() },
                dataType: "json",
