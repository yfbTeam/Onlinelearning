<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CertificateShow.aspx.cs" Inherits="SSSWeb.PersonalSpace.CertificateShow" %>
...
<head runat="server">
    ...
    <script>
        ...
        function ShowPlat() {
            ...
            $("#CerName").html(decodeURI(GetUrlDate.Name));
            $("#StuName").html("张三");
            $("#CourseName").html(decodeURI(GetUrlDate.CourseName));
            ...
            $.ajax({
                ...
                success: function (json) {
                    if (json.result.errNum.toString() == "0") {
                        ...
                        var Time = DateTimeConvert(item.CreateTime, "yyyy-MM-dd");
                        $("#CertificateID").html(item.Identifier);
                        $("#CreateTime").html(Time);
                        $("#CerName").html(item.cName);
                        $("#StuName").html(item.CreateName);
                        $("#CourseName").html(item.CourseName);
        ...
        <div class="cert_view" id="divCertificate">
            <div id="PreviewCer" class="viewimg" style="margin: 0 auto; margin-top: 20px; width: 470px;">
                ...
                <div id="StuName" style="position: absolute; z-index: 1; width: 460px; height: 30px; margin-top: -215px; text-align: center;">
                    <span style="font-size: 22px; letter-spacing: 3px;"><%=UserInfo.Name%></span>
                </div>
                ...
                <div style="left: 520px; top: 388px; margin-top: -105px; margin-left: -446px; position: absolute; z-index: 1;">
                    <span style="color: rgb(112, 112, 112); font-size: 12px;">发证单位：远程教学平台</span>
                </div>
                <div style="left: 520px; top: 388px; margin-top: -104px; margin-left: -246px; position: absolute; z-index: 1;">
                    <span style="color: rgb(112, 112, 112); font-size: 12px;">查询网址：http://192.168.1.101</span>
                </div>
