<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PersonalOffice.aspx.cs" Inherits="SSSWeb.PersonalOffice.PersonalOffice" %>
...
<body>
    ...
    <header class="repository_header_wrap manage_header">
        <div class="width repository_header clearfix">
            ...
            <div class="wenzi_tips fl">
                <img src="../images/gerenbangong.png" />
            </div>
            <nav class="navbar menu_mid fl">
                <ul>
                    <li class="active"><a href="#" onclick="ChangeSrc('/PersonalOffice/PersonInfo.aspx',this,'passport')">个人信息</a></li>
                    <li><a href="#" onclick="ChangeSrc('/PersonalOffice/NoticeManage.aspx',this)">通知公告</a></li>
                    <li><a href="#" onclick="ChangeSrc('/ResourceManage/MyResourceManage.aspx',this)">个人网盘</a></li>
                    <li><a href="#" onclick="ChangeSrc('/PersonalOffice/SkeDiskSet.aspx',this)">网盘配置</a></li>
                    <li><a href="#" onclick="ChangeSrc('/PersonalOffice/ResourceReviwe.aspx',this)">文件审批</a></li>
                </ul>
            </nav>
    ...
    <div class="onlinetest_item  pt90">
        <div class="myexam bordshadrad width" style="padding: 0px;">
            ...
            <div class="mycourse">
                <iframe src="/PersonalOffice/PersonInfo.aspx" width="100%" height="1200px" id="iframeContent" scrolling="no" allowtransparency="true" frameborder="no"></iframe>
            </div>
        </div>
    </div>
    <!--预览试卷-->
