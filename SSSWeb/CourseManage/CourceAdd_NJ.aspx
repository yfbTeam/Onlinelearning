<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CourceAdd_NJ.aspx.cs" Inherits="SSSWeb.CourseManage.CourceAdd_NJ" %>
...
<body style="background: #fff;">
    ...
    <script>
        ...
        function BindTeacher() {
            ...
            $("#LecturerName option[value='" + $("#HUserIdCard").val() + "']").attr("selected", true);
        }
        ...
        function AddCource() {
            ...
            var ClassNo = $("#HClassNo").val();
            if (ClassNo == "") {
                layer.msg("当前登录用户，或指定的负责的老师没有班级")
            }
            else {
                var ID = "";
                ...
                if (!Name.length || !LecturerName.length || !CourceType.length) {
                    ...
                    $.ajax({
                        ...
                        data: {
                            ...
                            func: "AddCource_NG", Name: Name, CourceType: CourceType,
                            CourseIntro: CourseIntro, CoursePic: CoursePic, StudyPlace: StudyPlace,
                            LecturerName: LecturerName, ID: ID, CreateUID: CreateUID, ClassNo: ClassNo
                        },
                        success: function (json) {
                            var result = json.result;
                            if (result.errNum == 0) {
        ...
        function GetGradeClass() {
            ...
            $.ajax({
                ...
                dataType: "json",
                async: false,
                data: { "Func": "GetClass", "HeadteacherNO": $("#HUserIdCard").val(),"Ispage":"false" },
                success: function (json) {
