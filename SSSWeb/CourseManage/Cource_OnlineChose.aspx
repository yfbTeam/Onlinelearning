    ...
    <script type="text/javascript">
                ...
                success: function (json) {
                    if (json.result.errNum.toString() == "0") {
                        $(json.result.retData).each(function () {
                            ...
                            "</div><p class=\"course_name\"><span>" + this.BatchUserName + "</span>" + a + "</p></div>";
        ...
        function registSing(ID, Command) {
            ...
            $.ajax({
                type: "Post",
                url: "../Common.ashx",//random" + Math.random(),//方法所在页面和方法名
                data: { "PageName": "CourseManage/CourceManage.ashx", Func: "SingUp", CourseID: ID, StuNo: Stu, Command: Command, ClssID: $("#HClassID").val() },
                dataType: "json",
                success: function (json) {
