<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StuSinLog.aspx.cs" Inherits="SSSWeb.CourseManage.StuSinLog" %>
        ...
        <header class="repository_header_wrap manage_header">
            <div class="width repository_header clearfix">
                ...
                <div class="wenzi_tips fl">
                    <img src="../images/xueyuanqiandao.png" />
                </div>
...
<%--                            <input type="text" name="" id="CourseName_my" value="" placeholder="请输入课程名称">
                ...
                <div class="newcourse_select clearfix" id="CourseSel">
                    <div class="stytem_select_right fl" style="margin-left: 10px;">
                        ...
                        <div class="search_exam fl pr">
                            <select name="" class="select" id="IsEffective" onchange="getData(1, 10)" style="height: 30px; margin: 0px 5px">
                                <option value="">签到是否有效</option>
                    ...
                    <div class="stytem_select_right fr">
                        <a href="javascript:;" class="newcourse" onclick="TimeSet()" id="icon-plus">
                            <i class="icon icon-plus"></i>时间设置
                        </a>
                    </div>
                </div>
                <div class="wrap">
...
<script type="text/javascript">
    ...
    function TimeSet() {
        OpenIFrameWindow('签到时间设置', 'SingTimeSet.aspx', '600px', '400px');
    }
    //获取数据
