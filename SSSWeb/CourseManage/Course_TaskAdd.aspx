<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Course_TaskAdd.aspx.cs" Inherits="SSSWeb.CourseManage.Course_TaskAdd" %>
    ...
    <script>
        ...
        function StudyTheCourseClass(classStr) {
            ...
            $.ajax({
                ...
                async: false,
                dataType: "json",
                data: { PageName: "/OnlineLearning/MyLessonsHandler.ashx", "Func": "StudyTheCourseStaff", CourseID: UrlDate.courseid, CourceType: UrlDate.coursetype },
                success: function (json) {
                    if (json.result.errNum.toString() == "0") {
                        if (json.result.retData.length <= 0) {
                            $("#div_Class").html("<label>暂无正在学习的员工！</label>");
                            return;
                        }
                    ...
                    else { $("#div_Class").html("<label>暂无正在学习的员工！</label>"); }
                },
