...
<body style="background: #fff;">
        ...
        <div style="background: #fff">
            <div class="newcourse_dialog_detail">
                ...
                <div class="course_form_div fl" style="margin-top: 0;">
                    ...
                    <input type="text" placeholder="证书名称" class="text" id="CerName" maxlength="20" />
                    <i class="stars"></i>
                </div>
    ...
    <script>
        ...
        function AddCource() {
            ...
            if (!Name || !LecturerName || !CourceType || !CerName || CerModel == "0") {
                layer.msg("课程名称、负责讲师、课程类型、证书名称、证书模板不能为空！");
            }
            else {
                $.ajax({
                    url: "../Common.ashx",
                    ...
                    data: {
                        ...
                        LecturerName: LecturerName, ID: ID, CreateUID: CreateUID, CerName: CerName, CerModel: CerModel
                    },
                    success: function (json) {
                        var result = json.result;
                        if (result.errNum == 0) {
