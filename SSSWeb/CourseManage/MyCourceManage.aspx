<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyCourceManage.aspx.cs" Inherits="SSSWeb.CourseManage.MyCourceManage" %>
    ...
    <script id="tr_Cource" type="text/x-jquery-tmpl">
        <li class="clearfix">
            ...
            <div class="fr mycourse_mes">
                <h1 class="mycourse_name" style="cursor: pointer;" onclick="CourceDetail(${ID})">${Name}</h1>
                ...
                <div class="succ_detaillist">
                    ...
                    <div class="detaillist_item">
                        ...
                        <div class="detaillist_desc"  style="cursor: pointer;">
                            <em class="icons">
                    ...
                    <div class="detaillist_item">
                        <div class="detaillist_title" style="cursor: pointer;">
                            待查看任务
                        </div>
    ...
    <form id="form1">
            ...
            <div class="width repository_header clearfix">
                ...
                <nav class="navbar menu_mid fl">
                    <ul>
                        ...
                        <li class="active"><a href="#">我负责的课程</a></li>
                    </ul>
                </nav>
        ...
        <div class="onlinetest_item width pt90">
            <div class="myexam bordshadrad">
                ...
                <div class="mycourse">
                    <ul class="mycourse_lists" id="tb_MyCource" style="min-height: 700px;">
                    </ul>
                </div>
            </div>
        </div>
...
<script>
    ...
    function getData(startIndex, pageSize) {
        ...
        $.ajax({
            ...
            async: false,
            dataType: "json",
            data: { "PageName": "CourseManage/CourceManage.ashx", "Func": "GetPageList", PageIndex: startIndex, pageSize: pageSize, ID: "", IdCard: $("#HUserIdCard").val() },
            success: OnSuccess,
            error: OnError
        });
    }
    ...
    function CourceDetail(ID) {
        window.location.href = 'CourseDetail.aspx?itemid=' + ID;//+ "&ParentID=" + Pid;
    }
    /*
    function Star() {
        //stars评价
