<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CourceAdd_MTG.aspx.cs" Inherits="SSSWeb.CourseManage.CourceAdd_MTG" %>
...
<body style="background: #fff;">
        ...
        <div style="background: #fff">
            <div class="newcourse_dialog_detail">
                ...
                <div class="course_form_div fl" style="margin-top: 0;">
                    <label for="">最少选课人数：</label>
                    <input type="text" placeholder="最少选课人数" class="text" id="SelMinNum" maxlength="20" />
                    <i class="stars"></i>
                </div>
                <div class="course_form_select fr" style="margin-top: 0;">
                    <label for="">上课时间：</label>
                    <select data-placeholder="上课时间" id="WeekID">
                ...
                <div class="course_form_div fl">
                    <label for="">最多选课人数：</label>
                    <input type="text" placeholder="最多选课人数" class="text" id="SelMaxNum" maxlength="20" />
                    <i class="stars"></i>
                </div>
    ...
    <script>
        ...
        function AddCource() {
            ...
            if (!Name || !LecturerName || !CourceType || !SelMinNum || !SelMaxNum) {
                layer.msg("课程名称、负责讲师、课程类型、选课人数不能为空！");
            }
            else {
                $.ajax({
                    url: "../Common.ashx",
                    ...
                    data: {
                        ...
                        func: "AddCource_MTG", Name: Name, CourceType: CourceType,WeekID:WeekID,
                        CourseIntro: CourseIntro, CoursePic: CoursePic, StudyPlace: StudyPlace,
                        LecturerName: LecturerName, ID: ID, CreateUID: CreateUID, SelMinNum: SelMinNum, SelMaxNum: SelMaxNum
                    },
        ...
        function bindModol() {
            $("#Model").html("<option value=\"0\">==选择证书模板==</option>");
            $.ajax({
                url: "../Common.ashx",
                type: "post",
                dataType: "json",
