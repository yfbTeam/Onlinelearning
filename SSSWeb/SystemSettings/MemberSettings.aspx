<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MemberSettings.aspx.cs" Inherits="SSSWeb.SystemSettings.MemberSettings" %>
...
<head runat="server">
    ...
    <script id="tr_User" type="text/x-jquery-tmpl">
        <tr>
            ...
            <td style="display: none;">${UniqueNo}</td>
        </tr>
    </script>
</head>
<body>
                    ...
                    <div class="tc">
                        <div class="Operation_area">
                            <div class="left_choice fl">
                                <ul>
                                    <li class="Sear">
                                        <select id="sel_Type" class="option" onchange="GetNotDataByRoleId(1)">
                                            <option value="false" selected="selected">老师</option>
                                            <option value="true">学生</option>
...
<script type="text/javascript">
    ...
    function SaveMemberSetting() {
        var flag = true;
        if (RoleName != "") {
            if ($("#sel_Type option:selected").html() != RoleName) {
                layer.msg("只能选择【" + RoleName + "】类型的用户");
                flag = false;
            }
        }
        if (flag) {
