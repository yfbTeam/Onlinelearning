<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PermissionSettings.aspx.cs" Inherits="SSSWeb.SystemSettings.PermissionSettings" %>
                    ...
                    <div class="tc">
                        <div class="t_message">
                            <div class="message_con">
                                <form>
                                    <div class="menubox1 left_navcon fl" style="min-height:390px;width:36%;">
                                        <!--头部-->
                                        <h1><span class="tit_name">角色管理</span><%--<span class="fr btn22"><a href="javascript:;" onclick="addHoverDom();">添加角色</a></span>--%></h1>
                                        <!--菜单区域-->
                                        <div class="menu">
                                            <ul>
                                                <li>
                                    ...
                                    <div class="right_dcon fr" style="min-height:390px;width:61%;margin-left:0;border:none;position:fixed;right:10px;">
                                        <div class="zTreeDemoBackground left" style="border:1px solid #ccc;min-height:390px;">
