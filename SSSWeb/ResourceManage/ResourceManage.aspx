                    ...
                    <div class="toolsbar fl">
                        <div class="bars">
                            ...
                            <a href="#" class="newfile">
                                ...
                                <span class="txt" onclick="javascript: appendAfterRow('1')">新建文件夹</span>
                            </a>
                    ...
                    <div class="docu_content">
                        ...
                        <div class="IsCheckAll">
                            <div class="clearfix" style="padding: 10px; border-top: 1px dotted #CFCFCF;">
                                ...
                                <div class="skydrive_size fl" style="left: 69%">
...
<script type="text/javascript">
    ...
    function upload() {
        ...
        OpenIFrameWindow('文件上传', 'HtmlUploder.aspx?FoldUrl=' + encodeURI(FoldUrl) + "&Pid=" + pid + "&code=" + Pcode + "&CreateUID=" + CreateUID + "&Type=Resource", '800px', '550px');
    }
    //格式化时间
    ...
    function EditName(em, id, oldname, FileUrl) {
        ...
        if (name == oldname) {
            ...
            $.ajax({
                url: "ResourceHander.ashx",//random" + Math.random(),//方法所在页面和方法名
                type: "post",
                async: false,
                dataType: "json",
