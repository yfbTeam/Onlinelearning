<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyResourceManage.aspx.cs" Inherits="SSSWeb.CourseManage.MyResource" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <!--header-->
            <header class="repository_header_wrap none">
                <div class="width repository_header clearfix">
                    <a class="logo fl" href="../AppManage/Index.aspx">
                        <img src="../images/logo.png" /></a>
                    <div class="wenzi_tips fl">
                        <img src="../images/jiaoshiyunpan.png" />
                    </div>
            ...
            <div class="skydrive width bordshadrad">
                ...
                <div class="docu_wrap">
                    ...
                    <div class="crumbs" id="Nav">
                        ...
                        <span style="float: right" id="Capaticy"><span id="Used"></span>M/<span id="All"></span>M</span>
                    </div>
                    <div class="docu_content">
                        ...
                        <div class="IsCheckAll">
                            ...
                            <ul class="document_list skydrive_docu_list" style="display: block; min-height: 460px;" id="tb_MyResource">
                            </ul>
                        </div>
                        <div class="none IsCheckAlla">
                            <div class="clearfix" style="padding: 10px; border-top: 1px dotted #CFCFCF;">
                                ...
                                <div class="bars none" style="margin: 5px 0px 0px 100px;">
                                    <a href="#" class="upload pr">
                                        <i class="icon  icon-download-alt"></i>
                                        <span class="txt" onclick="upload()">下载</span>
                                    </a>
                                    <a href="#" class="newfile">
                                        <i class="icon icon-trash"></i>
                            ...
                            <ul class="skydrive_grid_list clearfix" id="tb_MyResource1" style="min-height: 460px;">
                            </ul>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    function BaseSet() {
        ...
        $.ajax({
            ...
            dataType: "json",
            data: {
                "PageName": "ResourceManage/SkySet.ashx", "Func": "GetAllUserInfo", CreateUID: '<%=UserInfo.UniqueNo%>',"IsPage":'false'
            },
            success: function (json) {
                if (json.result.errNum.toString() == "0") {
                    $(json.result.retData).each(function () {
                        $("#Used").html(parseInt(this.SumSize / 1024 / 1024));
                        $("#All").html(this.AllLen)
                    });
                }
                else {
    ...
    function getData(startIndex, pageSize) {
        ...
        $.ajax({
            ...
            dataType: "json",
            data: {
                "PageName": "ResourceManage/MyResourceHander.ashx", "Func": "GetPageList", PageIndex: startIndex,
                pageSize: pageSize, CreateUID: CreateUID, "Pid": Pid, "DocName": DocName, "Postfixs": $("#Postfixs").val(),
                "CreateTime": $("#TimeQuery").val(), "CreateUID": '<%=UserInfo.UniqueNo%>'
            },
    ...
    function Down(id) {
        ...
        if (ids != "") {
            ...
            $.ajax({
                url: "../ResourceManage/MyResourceHander.ashx",//random" + Math.random(),//方法所在页面和方法名
                type: "post",
                async: false,
                dataType: "json",
    ...
    function Move(id) {
        ...
        if (ids == "") {
            ...
            OpenIFrameWindow('文件移动', 'MyResourceContent.aspx?Pid=' + pid + "&code=" + Pcode + "&id=" + id , '450px', '300px;');
        }
    }
    ...
    function upload() {
        ...
        OpenIFrameWindow('文件上传', 'HtmlUploder.aspx?FoldUrl=' + FoldUrl + "&Pid=" + pid + "&code=" + Pcode + "&CreateUID=" + CreateUID + "&Type=MyResource", '800px', '550px');
    }
    //格式化时间
