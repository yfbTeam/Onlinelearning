<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ResouceUpload.aspx.cs" Inherits="SSSWeb.ResourceManage.ResouceUpload" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#uploadify").uploadify({
                ...
                'uploader': 'ResouceFileUpload.ashx',
                //'buttonCursor': 'hand',
                'buttonText': '选择文件',
                ...
                'fileTypeExts': '*.docx;*.doc;*.ppt;*.pptx;*.pdf;*.caj;*.txt;*.rar;*.zip;*.jpg;*.gif;*.png;*.jpeg;*.xls;*.xlsx;*.mp4;*.mp3;*.flv;*.mpeg;*.mav;*.mpg',
                'fileTypeDesc:': '请选择docx doc ppt pptx pdf caj txt rar zip jpg gif png jpeg xls xlsx mp4; mp3 flv mpeg mav mpg文件',
                'progressData': 'all',
