<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PublicResoure.aspx.cs" Inherits="SSSWeb.ResourceManage.PublicResoure" %>
        ...
        <li class="clearfix">
            ...
            <div class="docu_messages fl">
                <p class="docu_title" onclick="FileClick(${ID},'${FileUrl}')">
                    ...
                    <a class="docu_name" href="#" title="${Name}">${cutstr(Name,40)}</a>
                </p>
                <div class="down_mes">
        ...
        <div>
            ...
            <%--<header class="repository_header_wrap">
                <div class="width repository_header clearfix">
                    ...
                    <div class="choiceversion fr">
                        <a href="../ResourceManage/CatologManage.aspx" target="_blank" class="btn-large" style="color: #FFFFFF; padding-right: 20px;">目录管理</a>
                    </div>
                </div>
            </header>--%>
            <div style="width: 100%; height: 50px; background: #0C6FC0 url(../images/repository_header.jpg) no-repeat center top;">
                <div class=" repository_header clearfix">
            ...
            <!--内容-->
            <div class="grid width clearfix pr">
                ...
                <div class="main clearfix pr">
                    ...
                    <section class="article_content bordshadrad">
                        <div class="modult_toolsbar clearfix">
                            ...
                            <div class="toolsbar fl">
                                <div class="bars">
                                    <a href="javascript:;" class="upload pr fl" id="CourceResource" style="height: 17px;">
                                        <span class="txt" onclick="CourceResource()">确定</span>
                                    </a>
                                    <div id="other" class="fl ml5">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        function OnDetailSuccess(json) {
            if (json.result.errNum.toString() == "0") {
                ...
                var html = '<div style="background:#fff url(../images/error.png) no-repeat center center; height: 500px;background-size:100%"></div>';
        ...
        function getData(startIndex, pageSize) {
            ...
            var CatagoryID = $("#HPeriod").val() + "|" + $("#HSubject").val() + "|" + $("#bookVersion").val() + "|" + $("#Textbook").val();
            ...
            $.ajax({
                ...
                dataType: "json",
                data: {
                    "PageName": "ResourceManage/PublicResoure.ashx", "Func": "GetPageList", PageIndex: startIndex, pageSize: pageSize,
                    "DocName": DocName, "GroupName": encodeURI($("#GroupName").val()), "Postfixs": $("#Postfixs").val(),
                    "IDCard": $("#HUserIdCard").val(), "CatagoryID": CatagoryID, "ChapterID": ChapterID
                },
    ...
    ,
        ...
        function upload() {
            ...
            var ChapterID = $("#HChapterID").val();
            var CatagoryID = $("#HPeriod").val() + "|" + $("#HSubject").val() + "|" + $("#bookVersion").val() + "|" + +$("#Textbook").val();;
            OpenIFrameWindow('文件上传', 'HtmlUploder.aspx?FoldUrl=' + FoldUrl +
                "&GroupName=" + GroupName + "&CatagoryID=" + CatagoryID + "&ChapterID=" + ChapterID + "&CreateUID=" + $("#HUserIdCard").val() + "&Type=ResourcesInfo", '800px', '550px');
        }
        //文件点击
        ...
        function BindleftMenu(data, id) {
            ...
            $(data).each(function () {
                if (this.BookID == $("#Textbook").val()) {
                    ...
                    if (this.Pid != 0 && this.Pid == id) {
                        if (TopMenuNum == 0 && i == 0) {
                            div += "<ul class=\"contentbox\" style=\"display: block;\"><li class=\"active\" onclick=\"changeMenu('" + id + "|" + this.ID + "')\">\<span class=\"text\">" + this.Name + "</span> </li>";
                            $("#HChapterID").val(id + "|" + this.ID);
                            // getData(1, 10);
                        }
                        if (TopMenuNum > 0 && i == 0) {
                            div += "<ul class=\"contentbox\"><li>\<span class=\"text\" onclick=\"changeMenu('" + id + "|" + this.ID + "')\">" + this.Name + "</span> </li>";
                        }
                        if (i > 0) {
                            div += "<li>\<span class=\"text\" onclick=\"changeMenu('" + id + "|" + this.ID + "')\">" + this.Name + "</span> </li>";
                        }
                        i++;
                    }
                }
        ...
        function BindPeriod() {
            ...
            if (CatagoryJson.GradeOfSubject.errNum.toString() == "0") {
                ...
                $(CatagoryJson.GradeOfSubject.retData).each(function () {
                    if (option.indexOf(this.GradeName) < 0) {
                        if (option.indexOf(this.Name) < 0) {
                            if (num == 0) {
                                option += "<option value='" + this.GradeID + "'  selected='selected'>" + this.Name + "</option>";

                                $("#HPeriod").val(this.GradeID);

                                BindSubject()
                            }
                            else {
                                option += "<option value='" + this.GradeID + "'>" + this.Name + "</option>";
                            }
                            num++;
                        }
                    }
        ...
        function Textbook() {
            ...
            if (CatagoryJson.Textbook.errNum.toString() == "0") {
                ...
                $(CatagoryJson.Textbook.retData).each(function () {
                    var option = "";
                    if (bookVersion == this.VersionID && currentPeriod == this.MajorID && this.SubID == currentSubjectID) {
                        if (i == 0) {
        ...
        function TextbookChange() {
            $("#BookName").html($("#Textbook").find("option:selected").text());
            Chapator();
        ...
        /*原学习平台 勿动
            ...
            function BindPeriod() {
                ...
                if (CatagoryJson.GradeOfSubject.errNum.toString() == "0") {
                    ...
                    $(CatagoryJson.GradeOfSubject.retData).each(function () {
                        if (option.indexOf(this.GradeName) < 0) {
                            if (num == 0) {
                                option += "<option value='" + this.GradeID + "'  selected='selected'>" + this.GradeName + "</option>";
                                $("#HPeriod").val(this.GradeID);
    
                                BindSubject()
                            }
                            else {
                                option += "<option value='" + this.GradeID + "'>" + this.GradeName + "</option>";
                            }
                            num++;
                        }
                        $("#Period").html(option);
            ...
            function BindSubject() {
                ...
                if (CatagoryJson.GradeOfSubject.errNum.toString() == "0") {
                    ...
                    $(CatagoryJson.GradeOfSubject.retData).each(function () {
                        ...
                        if (this.GradeID == SelPeriod) {
                            if (j == 0) {
                                option = "<option value='" + this.GradeID + "' selected='selected'>" + this.SubjectName + "</option>";
                                $("#HSubject").val(this.SubjectID);
                            }
                            else {
                                option = "<option value='" + this.GradeID + "'>" + this.SubjectName + "</option>";
                            }
                            j++;
                            $("#Subject").append(option);
                        }
            ...
            function Textbook() {
                ...
                if (CatagoryJson.Textbook.errNum.toString() == "0") {
                    ...
                    $(CatagoryJson.Textbook.retData).each(function () {
                        var option = "";
                        if (bookVersion == this.VersionID && currentPeriod == this.GradeID && this.SubjectID == currentSubjectID) {
                            if (i == 0) {
                                option = "<option value='" + this.Id + "' selected='selected'>" + this.Name + "</option>";
                                $("#BookName").html(this.Name);
                                $("#HTextboox").val(this.Id);
