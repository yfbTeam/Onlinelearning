<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PublicResouceUpload.aspx.cs" Inherits="SSSWeb.ResourceManage.PublicResouceUpload" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            var formData = { 'FoldUrl': GetUrlDate.FoldUrl, 'GroupName': GetUrlDate.GroupName, 'CatagoryID': GetUrlDate.CatagoryID, 'ChapterID': GetUrlDate.ChapterID, "CreateUID": GetUrlDate.CreateUID };
            $("#uploadify").uploadify({
                'swf': '/Scripts/Uploadyfy/uploadify/uploadify.swf',
                'uploader': 'PubFileUpload.ashx',
                //'buttonCursor': 'hand',
                'buttonText': '选择文件',
