<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyResourceContent.aspx.cs" Inherits="SSSWeb.CourseManage.MyResourceContent" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                url: "../Common.ashx",
                dataType: "text",
                data: { "PageName": "ResourceManage/MyResourceHander.ashx", "Func": "TreeNodes", CreateUID: $("#HUserIdCard").val(),"IsFolder":"1", "parm": new Date().getTime() },
