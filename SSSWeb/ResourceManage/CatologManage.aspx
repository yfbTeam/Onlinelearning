<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CatologManage.aspx.cs" Inherits="SSSWeb.ResourceManage.CatologManage" %>
    ...
    <header class="repository_header_wrap none">
        <div class="width repository_header clearfix">
            ...
            <nav class="navbar menu_mid fl">
                <ul>
                    <li class="active"><a href="#" onclick="ChangeSrc('SubjectManager.aspx',this)">学科管理</a></li>
                    <li><a href="#" onclick="ChangeSrc('TextbookVersionManager.aspx',this)">教材版本</a></li>
                    <li><a href="#" onclick="ChangeSrc('TextbookManager.aspx',this)">教材管理</a></li>
                </ul>
            </nav>
    ...
    <div class="onlinetest_item  pt90">
        <div class="stytem_select clearfix">
            <div class="stytem_select_left fl">
                <a href="javascript:;" class="on" onclick="ChangeSrc('MajorManager.aspx',this)">专业管理</a>
                <a href="javascript:;" onclick="ChangeSrc('SubjectManager.aspx',this)">学科管理</a>
                <a href="javascript:;" onclick="ChangeSrc('TextbookVersionManager.aspx',this)">教材版本</a>
                <a href="javascript:;" onclick="ChangeSrc('TextbookManager.aspx',this)">教材管理</a>
            </div>
        </div>
        <div class="myexam bordshadrad width" style="padding: 0px;">

            <div class="mycourse">
                <iframe src="/ResourceManage/MajorManager.aspx" width="100%" id="iframeContent" scrolling="no" allowtransparency="true" frameborder="no" height="800px"></iframe>
            </div>
        </div>
    </div>
