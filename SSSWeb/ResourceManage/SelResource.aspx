...
<head>
    ...
    <script id="tr_User" type="text/x-jquery-tmpl">
        <li class="clearfix">
            ...
            <div class="docu_messages fl" style="width:646px;">
                <p class="docu_title">
                    ...
                    <span class="docu_name" onclick="FolderClick(${ID},'${FileUrl}','${code}',${IsFolder})" title="${Name}">${cutstr(Name,30)}</span>
                </p>
            </div>

            <div class="skydrive_size fl" style="left:73%;">
                <span>{{if FileSize==0}}--
                    ...
                    <div class="docu_content">
                        ...
                        <div class="IsCheckAll">
                            <div class="clearfix" style="padding: 10px; border-top: 1px dotted #CFCFCF;">
                                ...
                                <div class="skydrive_size fl" style="left: 70%">
...
<script type="text/javascript">
    ...
    function CourceResource() {
        ...
        if (ids == "") {
            ...
            var IsVideo = UrlDate.IsVideo.replace('#', '');
            $.ajax({
