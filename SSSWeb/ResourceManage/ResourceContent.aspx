<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ResourceContent.aspx.cs" Inherits="SSSWeb.ResourceManage.ResourceContent" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                url: "../Common.ashx",
                dataType: "text",
                data: { "PageName": "ResourceManage/ResourceInfoHander.ashx", "Func": "TreeNodes", CreateUID: $("#HUserIdCard").val(), "Parm": new Date().getTime() },
        ...
        function treeClick() {
            ...
            var Url = $("#Url").val();
            var Pid = $("#Pid").val();
            if (Url == undefined || Pid == undefined || Url == "" || Pid == "") {
                layerMsg("请选择要移动的目录");
            }
            else {
    ...
    <form id="form1" runat="server">
        <div class="content_wrap">
            ...
            <div class="zTreeDemoBackground left">
                ...
                <input type="button" value="确定" onclick='treeClick()' style="background: rgb(84, 147, 215); border:none;display:block;border-radius: 3px; width: 100px; height: 34px; margin:10px auto; color: white;" />
            </div>
