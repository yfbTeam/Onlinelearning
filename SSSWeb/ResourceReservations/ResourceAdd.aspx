<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ResourceAdd.aspx.cs" Inherits="SSSWeb.ResourceReservations.ResourceAdd" %>
...
<body>
            ...
            <table class="tbEdit">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="ku">
                            <input name="OpenTime" type="text" id="OpenTime" class="Wdate" onfocus="WdatePicker({skin:'whyGreen',dateFmt:'HH:mm:ss',maxDate:'#F{$dp.$D(\'ClosedTime\') || $dp.$DV(\'2020-4-3\')}'})">
                            <span style="color: red;">*</span>
                        </td>
                    </tr>
                    <tr>
                        <td class="mi">关闭时间：</td>
                        <td class="ku">
                            <input name="ClosedTime" type="text" id="ClosedTime" class="Wdate" onfocus="WdatePicker({skin:'whyGreen',dateFmt:'HH:mm:ss',minDate:'#F{$dp.$D(\'OpenTime\') || $dp.$DV(\'2020-4-3\')}'})">
                            <span style="color: red;">*</span>
                        </td>
                    </tr>
    ...
    <script>
        ...
        function AddOfficeResource() {
            ...
            var timeCompare = GetUrlDate.Time;
            var MaxTime = "";
            var closetime = "";
            MaxTime = GetUrlDate.Time;//.replace(':', '');
            if (MaxTime!=undefined) {
                if (MaxTime.toString().indexOf(":") > -1) {
                    MaxTime = MaxTime.replace(':', '');
                }
            }
           
            if (ClosedTime != "") {
                closetime = ClosedTime.replace(':', '');
                if (closetime.indexOf(":") > -1) {
                    closetime = closetime.replace(':', '');
                }
            }

            if (MaxTime < closetime) {
                layer.alert("关闭时间不能大于" + timeCompare + "！");
                return;
            }
            $.ajax({
                url: "../Common.ashx",
                ...
                data: {
                    ...
                    Func: "AddNewResourceInfo", Name: Name, ResourceId: ResourceId, ResourceTypeName: PName, Address: Address, Area: Area,
        ...
        function AddCarResource() {
            ...
            if (Name == "" || Model == "" || LicensePlate == "" || SeatNum == "") {
                ...
                $.ajax({
                    ...
                    data: {
                        "PageName": "ResourceReservations/ResourceReservationInfoHandler.ashx",
                        Func: "AddNewResourceInfo", Name: Name, ResourceId: ResourceId, ResourceTypeName: PName, Model: Model, LicensePlate: LicensePlate,
