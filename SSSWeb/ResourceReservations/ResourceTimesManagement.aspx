<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ResourceTimesManagement.aspx.cs" Inherits="SSSWeb.ResourceReservations.ResourceTimesManagement" %>
...
<body>
    ...
    <div class="time_wrap pt90 width">
        ...
        <!---->
        <div class="onlinetest_right bordshadrad" style="min-height: 800px;">
    ...
    <script type="text/javascript">
                ...
                success: function (json) {
                    if (json.result.errNum.toString() == "0") {
                        ...
                        $(json.result.retData).each(function (j, m) {
                            ...
                            var startTimeDateID = 'startTimeDate' + id;
                            var endTimeDateID = 'endTimeDate' + id;
                            start += "<li class=\"data\" id='" + id + "'>";
                            start += "<input name=\"Wdate\" type=\"text\" value='" + m.BeginTime + "' id=\"" + startTimeDateID + "\" class=\"Wdate\" \onfocus=\"var date=maxDate('" + endTimeDateID + "');WdatePicker({skin:'whyGreen',dateFmt:'HH:mm:ss',maxDate:date})\"/>";
                            start += "<input name=\"Wdate\" type=\"text\" value='" + m.EndTime + "' id=\"" + endTimeDateID + "\" class=\"Wdate\" \onfocus=\"var date=minDate('" + startTimeDateID + "');WdatePicker({skin:'whyGreen',dateFmt:'HH:mm:ss',minDate:date})\"/>";
                        ...
                        $(".time li").html('');
                        var startTimeDateID = 'startTimeDate';
                        var endTimeDateID = 'endTimeDate';

                        start += "<li class=\"data\" id=\"Add\">";
                        start += "<input name=\"Wdate\" type=\"text\" value=\"\" id=\"startTimeDate\" class=\"Wdate\" \onfocus=\"var date=maxDate('" + endTimeDateID + "');WdatePicker({skin:'whyGreen',dateFmt:'HH:mm:ss',maxDate:date})\"/>";
                        start += "<input name=\"Wdate\" type=\"text\" value=\"\" id=\"endTimeDate\" class=\"Wdate\" \onfocus=\"var date=minDate('" + startTimeDateID + "');WdatePicker({skin:'whyGreen',dateFmt:'HH:mm:ss',minDate:date})\"/>";
                        start += "<input type=\"button\" value=\"+\" class=\"btn_add\" onclick=\"AddTimeControl()\"/>";
        ...
        function maxDate(endTimeDateID) {
            return "#F{$dp.$D(\'" + endTimeDateID + "\')||$dp.$DV(\'2020-4-3\')}";
        }

        function minDate(startTimeDateID) {
            return "#F{$dp.$D(\'" + startTimeDateID + "\')||$dp.$DV(\'2020-4-3\')}";
        }
        ...
        function AddTimeMethod() {
            ...
            $(".time li").each(function (e, t) {
                if ($(this).find("input").val() == "") {
                    ...
                    if (id.indexOf("Add") >= 0) {
                        var obj = new Object();
                        var startID = 'startTimeDate' + id.replace("Add", "");
                        var endID = 'endTimeDate' + id.replace("Add","");

                        obj.startTimeDate = $(this).find("#" + startID).val();
                        obj.endTimeDate = $(this).find("#" + endID).val();
                        ...
                        if ($("#HResourceId").val() == "") {
                            var obj = new Object();
                            obj.Id = id;
                            var startID = 'startTimeDate' + id;
                            var endID = 'endTimeDate' + id;
                            obj.startTimeDate = $(this).find("#" + startID).val();
                            obj.endTimeDate = $(this).find("#" + endID).val();
        ...
        function AddTimeControl() {
            ...
            var liID = 'Add' + RandomNum;
            var startTimeDateID = 'startTimeDate' + RandomNum;
            var endTimeDateID = 'endTimeDate' + RandomNum;

            start += "<input name=\"Wdate\" type=\"text\" value=\"\" id=\"" + startTimeDateID + "\" class=\"Wdate\" \onfocus=\"var date=maxDate('" + endTimeDateID + "');WdatePicker({skin:'whyGreen',dateFmt:'HH:mm:ss',maxDate:date})\"/>";
            start += "<input name=\"Wdate\" type=\"text\" value=\"\" id=\"" + endTimeDateID + "\" class=\"Wdate\" \onfocus=\"var date=minDate('" + startTimeDateID + "');WdatePicker({skin:'whyGreen',dateFmt:'HH:mm:ss',minDate:date})\"/>";
            start += "<input type=\"button\" value=\"+\" class=\"btn_add\" onclick=\"AddTimeControl()\"/>";
            start += "<input type=\"button\" value=\"x\" class=\"btn_delete\" onclick=\"DelTimeControl(this,'','')\"/>";

            $(".time").append("<li class=\"data\" id=\"" + liID + "\">" + start + "</li>")
        }
        var ids = "";
