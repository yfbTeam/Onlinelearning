<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ResourceApproval.aspx.cs" Inherits="SSSWeb.ResourceReservations.ResourceApproval" %>
...
<body style="background: #fff;">
    ...
    <input type="hidden" id="CourceID" value="" />
    <%--<form id="form1">--%>
    <div class="MenuDiv">
        <table class="tbEdit">
            <tbody>
        ...
        function AddResourceApproval() {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    Func: "AddResourceReservation", Id: ID, ApprovalStutus: ApprovalStutus, UserName: UserName, Name: Name,
                    ApprovalOpinion: ApprovalOpinion, ApprovalPeople: ApprovalPeople, CourceID: $("#CourceID").val()
                },
