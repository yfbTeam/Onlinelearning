<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AssetManagement.aspx.cs" Inherits="SSSWeb.ResourceReservations.AssetManagement" %>
...
<body>
    ...
    <script type="text/javascript">
        ...
        function AddAsset() {
            OpenIFrameWindow('新增资产', 'AssetManagementAdd.aspx', '700px', '80%');
        }

        function EditAsset(obj, id, status) {
            OpenIFrameWindow('查看资源', 'AssetManagementAdd.aspx?ID=' + id + '&type=' + status, '700px', '80%');
        }
