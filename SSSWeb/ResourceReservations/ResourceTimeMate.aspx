<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ResourceTimeMate.aspx.cs" Inherits="SSSWeb.ResourceReservations.ResourceTimeMate" %>
...
<head runat="server">
    ...
    <style>
        .item_sides li .item_chapter span{width:178px;}
    </style>
</head>
<body>
    ...
    <div class="time_wrap clearfix" style="padding: 20px;">
        ...
        <div style="margin-left: 240px; min-height: 240px; border: 1px solid #4e95ca; background: #fff;">
            <h1 class="title_mate">分类资源和时间段匹配，用于限制资源预定申请操作的时间范围选择。</h1>
    ...
    <script type="text/javascript">
        ...
        function TimesClick() {
            parent.window.location.href = "ResourceTimesManagement.aspx";
