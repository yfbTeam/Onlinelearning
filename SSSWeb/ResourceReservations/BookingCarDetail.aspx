<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BookingCarDetail.aspx.cs" Inherits="SSSWeb.ResourceReservations.BookingCarDetail" %>
        ...
        function submitData() {
            ...
            if (para == '') {
                ...
                if (isOpen) {
                    ...
                    if (id == "" || id == null) {
                        OpenIFrameWindow('预约页面', 'ResourceReservationAdd.aspx?ReSourceInfoId=' + UrlDate.Id + "&CourseAppoint=" + UrlDate.CourseAppoint+ '&ReSourceClassId=' + UrlDate.ResourceId + '&selectData=' + selectData + '&TimeInterval=' + timeManageId, '700px', '500px');
                    } else {
