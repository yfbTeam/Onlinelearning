<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ResourceReservationAdd.aspx.cs" Inherits="SSSWeb.ResourceReservations.ResourceReservationAdd" %>
...
<body style="background: #fff;">
    ...
    <div class="MenuDiv">
        <table class="tbEdit">
            <tbody>
                <tr>
                    <td class="mi">预约<span class="m">事由：</span>
                    </td>
                    <td class="ku">
    ...
    <script>
        ...
        function AddResourceReservation() {
            var CourseID = UrlDate.CourseAppoint == undefined ? "" : UrlDate.CourseAppoint;
            ...
            if (Name == "" || School == "" || Telephone == "" || Address == "") {
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        Func: "AddResourceReservation", "Name": Name, "School": School, "Telephone": Telephone,
                        "Address": Address, "Remark": Remark, "ApprovalStutus": ApprovalStutus, "ApprovalOpinion": ApprovalOpinion,
                        "ReSourceInfoId": UrlDate.ReSourceInfoId, "ReSourceClassId": UrlDate.ReSourceClassId,
                        "TimeInterval": UrlDate.TimeInterval, "AppoIntmentTime": UrlDate.selectData,
                        "ID": ID, "UserName": UserName, "UserIdCard": UserIdCard, CourseID: CourseID
                    },
