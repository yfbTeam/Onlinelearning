                ...
                <div class="clearfix">
                    ...
                    <div class="clearfix">
                        ...
                        <div class="course_form_div clearfix">
                            ...
                            <div id="picker" style="width: 195px; height: 195px; margin-left: 80px; padding-top: 40px;"></div>
                            <%--<select id="ModelCss">
                                <option value="OrangeRed" selected="selected">橘红色</option>
                                <option value="lightBlue">淡蓝色</option>
                                <option value="blue">蓝色</option>
                                <option value="weightBlue">深蓝色</option>
                                <option value="Green">绿色</option>

                                <option value="Yellow">黄色</option>
                                <option value="lightPuple">淡紫色</option>

                                <option value="Puple">紫色</option>
                                <option value="weightPuple">深紫色</option>

                                <option value="Puple1">亮紫色</option>
                            </select>--%>
                        </div>
