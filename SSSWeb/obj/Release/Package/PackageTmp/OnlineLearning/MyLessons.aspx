<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyLessons.aspx.cs" Inherits="SSSWeb.OnlineLearning.MyLessons" %>
...
<body>
    ...
    <div class="onlinetest_item width pt90">
        <div class="myexam bordshadrad">
            ...
            <div class="mycourse">
                <ul class="mycourse_lists" id="ul_mylessons" style="min-height:700px;"></ul>
            </div>
        </div>
    </div>
    <footer>
