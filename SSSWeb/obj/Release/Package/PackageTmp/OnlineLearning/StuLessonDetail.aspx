            ...
            <div class="test_lists_right fr clearfix">
                <div class="dates_a  pr" style="width: 280px">
                    <div class="seedeletion seedeletiona" >
                        <a href="javascript:;" class="homework fl" onclick="DownLoad('${Attachment}');" style="padding:0px 4px;"><i class="icon icon-download-alt" style="color:#fff;"></i>下载作业</a>
                        {{if IsCanCorrect==0}} 
        ...
        <li id="li_tabwork_${Id}" workrelid="${WorkRelId}" iscorrect="${IsCorrect}">
            <div class="homework_mes clearfix">
                <div class="homework_mes_left fl">
                    <h2><a href="javascript:;" style="cursor:pointer;" onclick="LookWorkStatistics('${Id}','${Name}');">${Name}</a><span class="submit"><label id="lbl_commit_${Id}">${WorkRelCount}</label>人已提交</span>{{if IsOpen==0}}<span class="nosubmit" style="cursor:pointer;" onclick="GetStuWorkCompleteInfo('${Id}');"><label id="lbl_nocommit_${Id}">0</label>人未提交</span>{{/if}}</h2>
                    <p>
                        <span>发布人：${CreateName}</span>
                        <span>发布时间：${DateTimeConvert(CreateTime,"yyyy-MM-dd HH:mm")}</span>
...
<body>
    ...
    <input type="hidden" id="HStuIDCard" value="<%=UserInfo.IDCard %>" />
    ...
    <div class="width course_student_wrap clearfix">
        <div class="clearfix" style="display: block;">
            ...
            <div class="course_learned fr bordshadrad pr">
                ...
                <p class="learned_title">正在学习的人</p>
                <div class="class_selectwrap">
                    <ul class="class_select" id="ul_studystu"><li><span>暂无正在学习的人！</span></li></ul>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    //        OpenIFrameWindow('添加评价', '/OnlineLearning/EvalueContent.aspx?ID=' + ID + "&Evalue=" + star, '630px', '70%');
    //    }
    //}
                ...
                if (json.result.errNum.toString() == "0") {
                    ...
                    if (json.result.retData.length <= 0) {
                        ...
                        $(json.result.retData).each(function () {
                            ...
                            //    }
                            //}
                            $("#ul_class").append("<li><div class='learned_students_img'><img src=\"" + this.AbsHeadPic + "\" alt='' onerror=\"javascript:this.src='/images/discuss_img_01.jpg'\"/></div><p class='learned_students_name'>" + this.Name + "</p></li>");
                        });
