            ...
            <div class="width repository_header clearfix">
                ...
                <nav class="navbar menu_mid fl">
                    <ul>
                        ...
                        <li currentclass="active"><a href="/CourseManage/MyCourceManage.aspx">我的课程</a></li>
                    </ul>
                </nav>
...
<script type="text/javascript">
    ...
    //添加课程
    function AddCource() {
        OpenIFrameWindow('添加课程', '/CourseManage/CourceAdd.aspx', '600px', '500px');
    }
    //修改课程
    function EditCource(id) {
        OpenIFrameWindow('修改课程', '/CourseManage/CourceAdd.aspx?ID=' + id, '600px', '500px');
    }
    //课程审核
    //function Check(id) {
