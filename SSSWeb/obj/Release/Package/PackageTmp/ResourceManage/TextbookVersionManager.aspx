...
<head runat="server">
    ...
    <script id="tr_User" type="text/x-jquery-tmpl">
        <tr>
            ...
            <td>${CreateTime}</td>  
            <td>
                <input type="button" class="Topic_btn" value="编辑" onclick="javascript: OpenIFrameWindow('编辑教材版本', 'TextbookVersionEdit.aspx?itemid=${Id}', '560px', '200px');" />
    ...
    function getData(startIndex) {
        ...
        $.ajax({
            ...
            data: {
                ...
                func: "GetTextbookVersionPageData",
                Name: Name,
