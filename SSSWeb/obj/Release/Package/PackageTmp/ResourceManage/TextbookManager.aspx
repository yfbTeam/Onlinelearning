<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TextbookManager.aspx.cs" Inherits="SSSWeb.ResourceManage.TextbookManager" %>
...
<head runat="server">
    ...
    <script id="tr_User" type="text/x-jquery-tmpl">
        <tr>
            ...
            <td>${PeriodName}</td>
            <td>
                <input type="button" class="Topic_btn" value="管理目录" onclick="javascript: OpenIFrameWindow('管理教材目录', 'TextbookCatalogMgr.aspx?itemid=${Id}', '560px', '300px');" />
