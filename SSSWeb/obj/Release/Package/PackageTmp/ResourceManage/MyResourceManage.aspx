                ...
                <div class="docu_wrap">
                    ...
                    <div class="docu_content">
                        ...
                        <div class="IsCheckAll">
                            ...
                            <ul class="document_list skydrive_docu_list" style="display: block; min-height: 500px;" id="tb_MyResource">
                            </ul>
                        </div>
                        <div class="none IsCheckAlla">
                            ...
                            <ul class="skydrive_grid_list clearfix" id="tb_MyResource1" style="min-height: 500px;">
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <footer>
                <div class="footer width clearfix">
                    ...
                    <div class="footer_right fr">
                        <p>咨询电话: 010-83068508 400服务电话: 4000-910-665 传真: 010-83068505</p>
...
<script type="text/javascript">
    ...
    function Move(id) {
        ...
        if (ids == "") {
            ...
            OpenIFrameWindow('文件移动', '/ResourceManage/MyResourceContent.aspx?Pid=' + pid + "&code=" + Pcode + "&id=" + id + "&random=" + Math.random(), '450px', '300px;');
        }
    }
    ...
    function upload() {
        ...
        OpenIFrameWindow('文件上传', '/ResourceManage/MyResouceUpload.aspx?FoldUrl=' + FoldUrl + "&Pid=" + pid + "&code=" + Pcode + "&CreateUID=" + CreateUID, '400px', '300px');
    }
    //格式化时间
