...
<body>
    ...
    <header class="repository_header_wrap manage_header">
        <div class="width repository_header clearfix">
            <a href="/AppManage/Index.aspx" class="logo fl">
            ...
            <nav class="navbar menu_mid fl">
                <ul>
                    <li class="active"><a href="#" onclick="ChangeSrc('/ResourceManage/SubjectManager.aspx',this)">学科管理</a></li>
                    <li><a href="#" onclick="ChangeSrc('/ResourceManage/TextbookVersionManager.aspx',this)">教材版本</a></li>
                    <li><a href="#" onclick="ChangeSrc('/ResourceManage/TextbookManager.aspx',this)">教材版本</a></li>
                </ul>
            </nav>
    ...
    <div class="onlinetest_item  pt90">
        <div class="myexam bordshadrad width" style="padding: 0px;">
            ...
            <div class="mycourse">
                <iframe src="/ResourceManage/SubjectManager.aspx" width="100%" height="1200px" id="iframeContent" scrolling="no" allowtransparency="true" frameborder="no"></iframe>
            </div>
        </div>
    </div>
    <!--预览试卷-->
