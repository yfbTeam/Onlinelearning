<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TextbookVersionEdit.aspx.cs" Inherits="SSSWeb.ResourceManage.TextbookVersionEdit" %>
                        ...
                        <div class="t_message">
                            <div class="message_con">
                                <form>
                                    <table class="m_top">
                                        <tr>
                                            <td class="mi"><span class="m">教材版本名称：</span></td>
                                            <td class="ku">
...
<script type="text/javascript">
    ...
    function Save() {
        ...
        var Id = $("#hid_Id").val();
        var func = Id != "" ? "UpdateTextbookVersion" : "AddTextbookVersion";
        $.ajax({
            url: "../Common.ashx",
            type: "post",
            async: false,
