<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SubjectEdit.aspx.cs" Inherits="SSSWeb.ResourceManage.SubjectEdit" %>
                        ...
                        <div class="t_message">
                            <div class="message_con">
                                <form>
                                    <table class="m_top">
                                        <tr>
                                            <td class="mi"><span class="m">科目名称：</span></td>
                                            <td class="ku">
...
<script type="text/javascript">
    ...
    function Save() {
        ...
        var Id = $("#hid_Id").val();
        var func = Id != "" ? "UpdateSubject" : "AddSubject";
        $.ajax({
            url: "../Common.ashx",
            type: "post",
            async: false,
