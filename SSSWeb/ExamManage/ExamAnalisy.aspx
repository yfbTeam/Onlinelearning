<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExamAnalisy.aspx.cs" Inherits="SSSWeb.ExamManage.ExamAnalisy" %>
            ...
            <div class="width repository_header clearfix">
                ...
                <nav class="navbar menu_mid fl">
                    <ul id="Menu">
                            ...
                            <li><a href="ExamManager.aspx">试卷管理</a></li>
                            <li><a href="MyExam.aspx">考试管理</a></li>
                            <li class="active"><a href="#">考试分析</a></li>
                    </ul>
                </nav>
