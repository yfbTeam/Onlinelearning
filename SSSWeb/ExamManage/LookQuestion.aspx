<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LookQuestion.aspx.cs" Inherits="SSSWeb.ExamManage.LookQuestion" %>
    ...
    function BindQuestion() {
        ...
        $.ajax({
            ...
            data: {
                ...
                "action": FuncName, "ID": UrlDate.Id, "IsPage": "false"
            },
            success: function (json) {
                var result = json.result;
                var Data = result.retData;
                var html = "";
                var bookid = Data[0].Catagory.split("|");
