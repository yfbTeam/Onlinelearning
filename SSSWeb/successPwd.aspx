<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="successPwd.aspx.cs" Inherits="SSSWeb.successPwd" %>
...
<body>
        ...
        <div class="forget_wrap width" style="min-height:578px;margin-top:200px;">
            <div class="retrievepwd-progress clearfix">
                ...
                <div class="retrievepwd-cont">
                    ...
                    <a href="javascript:void(0);" id="next-vcode-btn" class="btn-public-38 next-btn">5秒后回到登陆页面
                    </a>
                </div>
            </div>
        </div>
    ...
    <script type="text/javascript">
        ...
        function doLoop() {
            nums--;
            if (nums > 0) {
                $("#next-vcode-btn").html(nums + '秒后回到登陆页面');
            } else {
