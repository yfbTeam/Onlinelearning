...
namespace SSSBLL
{
    public partial class CourseService : BaseService<Course>, ICourseService
    {
        ...
        /// <param name="StuName"></param>
        /// <returns></returns>
        public string StuSingUp(string courseid, string stuno, string ClssID)
        {
            return courcedal.StuSingUp(courseid, stuno, ClssID);
        }
        ...
        /// </summary>
        /// <returns></returns>
        public JsonModel HotCourse(string StuNo)
        {
            BLLCommon common = new BLLCommon();
            try
            {

                DataTable modList = courcedal.HotCourse(StuNo);
        ...
        {
            return courcedal.AddCourse(entity, CerName, CerModel);
        }
        #endregion
        ...
        {
            return courcedal.UpdateCourse(entity, CerName, CerModel);
        }
        #endregion
        ...
        {
            return courcedal.AddCourse_MTG(entity);
        }
        #endregion
        #region 添加课程
        /// <summary>
        ...
        {
            return courcedal.AddCourse_NG(entity, ClassNo);
        }
        #endregion
        #region 修改课程
        /// <summary>
        ...
        {
            return courcedal.UpdateCourse_MTG(entity);
        }
        #endregion
        ...
        {
            return courcedal.RealeseCourse(ID, StartTime, EndTime, Classes);
        }
        #endregion
