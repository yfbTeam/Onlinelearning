...
{
    public class HanziShiftPhoneticize
    {
        #region 简拼
        ...
        public string GetPYChar1(string c)
        {
            byte[] array = new byte[2];
            array = System.Text.Encoding.Default.GetBytes(c);
            int i = (short)(array[0] - '\0') * 256 + ((short)(array[1] - '\0'));
            if (i < 0xB0A1) return "z";
        ...
        public string[] pyName = new string[]  
        #region 赋值pyName
        {  
        ...
        public string[] pyName2 = new string[]
        #region MyRegion
...
　　    "zi","zong","zou","zu","zuan","zui","zun","zuo"};
        ...
        #endregion
        /// <summary>  
        /// 从字符串中获取汉字拼音首字母，不是汉字则原样输出  zhuang
        /// </summary>  
        /// <param name="hz"></param>  
        /// <returns></returns>  
