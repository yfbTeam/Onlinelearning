...
namespace SSSHanderler.ResourceReservations
{
    ...
    public class ResourceTimeMappingIdHandler : IHttpHandler
    {
        ...
        Appoint_ResourceTimeMappingIdService resourceService = new Appoint_ResourceTimeMappingIdService();
        ...
        private void GetResourceTimeMapping(HttpContext context)
        {
            try
            {
                ...
                ht.Add("TableName", "Appoint_ResourceTimeMappingId");
        ...
        private void AddResourceTimeMapping(HttpContext context)
        {
            try
            {
                ...
                Appoint_ResourceTimeMappingId resource = new Appoint_ResourceTimeMappingId();
                ...
                else
                {
                    ...
                    {
                        List<Appoint_ResourceTimeMappingId> list = (List<Appoint_ResourceTimeMappingId>)jsonModel.retData;
                        if (list.Count == 0)
                        {
