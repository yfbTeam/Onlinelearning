...
namespace SSSHanderler.ResourceReservations
{
    ...
    public class ResourceReservationClaHandler : IHttpHandler
    {
        ...
        Appoint_ResourceReservationClaService courcebll = new Appoint_ResourceReservationClaService();
        ...
        private void GetLeftMenu(HttpContext context)
        {
            try
            {
                ...
                ht.Add("TableName", "Appoint_ResourceReservationCla");
                ht.Add("ID", context.Request["ID"].SafeToString());
                ht.Add("PID", context.Request["PID"].SafeToString());
                ht.Add("CPID", context.Request["CPID"].SafeToString());
        ...
        private void AddNewResourceMenu(HttpContext context)
        {
            try
            {
                Appoint_ResourceReservationCla resource = new Appoint_ResourceReservationCla();
            ...
            try
            {
                ...
                if (ids.Contains(","))
                {
                    ...
                    for (int i = 0; i < ids.Length; i++)
                    {
                        ...
                        {
                            Appoint_ResourceReservationCla resourceInfo = jsonModel.retData as Appoint_ResourceReservationCla;
