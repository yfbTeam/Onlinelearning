...
namespace SSSHanderler.ResourceReservations
{
    ...
    public class ResourceReservationInfoHandler : IHttpHandler
    {
        ...
        Appoint_ResourceReservationInfoService resourceService = new Appoint_ResourceReservationInfoService();
        ...
        private void GetPageList(HttpContext context)
        {
            try
            {
                ...
                ht.Add("TableName", "Appoint_ResourceReservationInfo");
                bool ispage = true;
        ...
        private void AddNewResourceInfo(HttpContext context)
        {
            try
            {
                Appoint_ResourceReservationInfo resource = new Appoint_ResourceReservationInfo();
            ...
            try
            {
                ...
                if (ids.Contains(","))
                {
                    ...
                    for (int i = 0; i < idarry.Length; i++)
                    {
                        ...
                        {
                            Appoint_ResourceReservationInfo resourceInfo = jsonModel.retData as Appoint_ResourceReservationInfo;
