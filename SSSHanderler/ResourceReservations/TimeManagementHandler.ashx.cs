...
namespace SSSHanderler.ResourceReservations
{
    ...
    public class TimeManagementHandler : IHttpHandler
    {
        ...
        Appoint_TimeManagementService resourceService = new Appoint_TimeManagementService();
        Appoint_ResourceReservationService rrService = new Appoint_ResourceReservationService();
        ...
        private void GetDataByID(HttpContext context)
        {
            try
            {
                ...
                ht.Add("TableName", "Appoint_TimeManagement");
        ...
        private void AddTime(HttpContext context)
        {
            try
            {
                ...
                Appoint_TimeManagement resource = new Appoint_TimeManagement();
