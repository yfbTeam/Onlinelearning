...
namespace SSSHanderler.ResourceReservations
{
    ...
    public class TimeIntervalHandler : IHttpHandler
    {
        ...
        Appoint_TimeIntervalService resourceService = new Appoint_TimeIntervalService();
        Appoint_TimeManagementService timeManagementService = new Appoint_TimeManagementService();
        Appoint_ResourceTimeMappingIdService resourceTimeMappingIdService = new Appoint_ResourceTimeMappingIdService();
        ...
        private void GetRadioData(HttpContext context)
        {
            try
            {
                ...
                ht.Add("TableName", "Appoint_TimeInterval");
               // ht.Add("Type", "1");
        ...
        private void DelTimeMenu(HttpContext context)
        {
            try
            {
                Appoint_TimeManagement tm = new Appoint_TimeManagement();
                ...
                if (jsonModel.errNum == 0)
                {
                    ...
                    if(jsonModel.errNum == 0)
                    {
                        List<Appoint_TimeManagement> tmList = (List<Appoint_TimeManagement>)jsonModelTimeManagement.retData;
                        if (tmList.Count == 0)
                        {
                        ...
                        {
                            Appoint_ResourceTimeMappingId mp = new Appoint_ResourceTimeMappingId();
                            List<Appoint_ResourceTimeMappingId> mappingList = (List<Appoint_ResourceTimeMappingId>)jsonModelMapping.retData;
                        ...
                        Appoint_TimeInterval resourceInfo = jsonModel.retData as Appoint_TimeInterval;
                            resourceInfo.Id = id;
        ...
        private void AddTimeInterval(HttpContext context)
        {
            try
            {
                ...
                Appoint_TimeInterval resource = new Appoint_TimeInterval();
