...
namespace SSSHanderler.ResourceReservations
{
    ...
    public class AssetManagementHandler : IHttpHandler
    {
        ...
        Appoint_AssetManagementService resourceService = new Appoint_AssetManagementService();
        ...
        private void GetPageList(HttpContext context)
        {
            try
            {
                ...
                ht.Add("TableName", "Appoint_AssetManagement");
                bool ispage = true;
        ...
        private void AddAssetManagement(HttpContext context)
        {
            try
            {
                Appoint_AssetManagement resource = new Appoint_AssetManagement();
        ...
        private void DelAssetManagement(HttpContext context)
        {
            try
            {
                ...
                {
                    Appoint_AssetManagement asset = jsonModel.retData as Appoint_AssetManagement;
                    asset.Id = id;
                    asset.IsDelete = 1;
